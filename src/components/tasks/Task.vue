<template>
  <li class="list-group-item py-3">
    <div class="d-flex justify-content-start align-items-center">
      <input class="form-check-input mt-0 completed" :class="completedClass" type="checkbox"
...
{
  const changedTask = { ...props.task, name: event.target.value };
  isEdit.value = false;
  emit('updated', changedTask);
}
</script>
